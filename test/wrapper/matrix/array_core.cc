...
go_bandit([] {
  describe("MatrixArrayCore", [] {
    it("should not be abstract class", [] {
      std::is_abstract<MatrixArrayCore<float, 3, 3>>::value must_not be_truthy;
    });

    it("should be initialized with list", [] {
      [] {
        MatrixArrayCore<float, 2, 2> array = {1.f, 2.f, 3.f, 4.f};
        MatrixArrayCore<float, 2, 2> array2 = {{1.f, 2.f}, {3.f, 4.f}};
    ...
    MatrixArrayCore<float, 3, 2> array = {1.f, 2.f, 3.f, 4.f, 5.f, 6.f};
    auto array2 = array;
    array2 *= 2;
    auto array3 = array;
    array3 *= 3;
